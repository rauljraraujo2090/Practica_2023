...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> AÑADIR A LA CESTA</a>
													<?php } else {?>
							<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
									</div>
											...
											<div class="review-form">
												<div class="form-container">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">ReviewSS <span class="astk">*</span></label>
...
<?php $cid=$row['category'];
	...
	<div class="container-fluid owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">AÑADIR A LA CESTA</a>
