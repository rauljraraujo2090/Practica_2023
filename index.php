...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-6 col-12">
                    <div class="nav-inner">
                        ...
                        <div class="mega-category-menu">
                            <span class="cat-button"><i class="lni lni-menu"></i>Todas las Categorias</span>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="nav-social">
                        ...
                        <ul>
                            <li>
                                <a href="https://web.facebook.com/iestphuanta.edu.pe" target="_blank"><i class="fa-brands fa-facebook"></i></a>
                            </li>


                            <li>
                                <a href="https://wa.link/k4f4d3" target="_blank"><i class="fa-brands fa-whatsapp"></i></a>
                            </li>
    ...
    <!-- Modal -->
    <div class="modal fade bg-whiter" id="templatemo_search" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./assets2/img/pc_1.png" alt="">
                        </div>
