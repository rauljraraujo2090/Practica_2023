                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Omega</b> Genius</h1>
                                <h3 class="h2">Ofrecemos Productos en Tecnologia</h3>
                                <p>
                                    Tenemos los mejores productos cerca de ti  
                                    "Huanta cada vez mas cerca de la tecnologia" <a rel="sponsored" class="text-success" href="https://templatemo.com" target="_blank">TemplateMo</a> website. 
